...
public class FormAlquiler extends javax.swing.JFrame {
    ...
    public FormAlquiler() {
        ...
        // ✅ Instanciar ControlAlquiler usando el Builder
     ControlAlquiler objetoVenta = new ControlAlquiler.Builder()
    .habilitarLogs(true) // Opcional: activa logs si lo necesitas
    .build();
...
// ✅ Llamar al método correctamente
    ...
    private void txtbuscarclienteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarclienteKeyReleased
       // ✅ Crear la instancia correctamente con el Builder
    ControlAlquiler objetoVenta = new ControlAlquiler.Builder()
        .habilitarLogs(true) // Opcional, si quieres ver logs
        .build();
    ...
    private void tbclientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbclientesMouseClicked
        // ✅ Crear la instancia de ControlAlquiler con el Builder
    ControlAlquiler objetoVenta = new ControlAlquiler.Builder()
        .habilitarLogs(true) // Opcional: activa logs si lo necesitas
        .build();
