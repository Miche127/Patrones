...
public class FormAlquiler extends javax.swing.JFrame {
    ...
    private ControlAlquiler objetoVenta;
    ...
    public FormAlquiler() {
        ...
        DBAdapter adapter = new MySQLAdapter(); // O PostgreSQLAdapter si usamos PostgreSQL
        objetoVenta = new ControlAlquiler(adapter);
