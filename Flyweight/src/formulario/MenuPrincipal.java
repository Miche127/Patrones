...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void btnClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClientesActionPerformed
        ...
        //AccesoFormularioProxy proxy = new AccesoProxy(" a clientes");
        VistaFormulario vista = new FormularioUI(new VistaFormularioCliente());
        Proxy.AccesoFormularioProxy proxy = new Proxy.AccesoProxy("clientes");
    ...
    private void btnAlmacenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlmacenActionPerformed
        ...
        //AccesoFormularioProxy proxy = new AccesoProxy(" a almacenes");
        VistaFormulario vista = new FormularioUI(new VistaFormularioProducto());
        Proxy.AccesoFormularioProxy proxy = new Proxy.AccesoProxy("almacen");
        proxy.acceder(vista, this);
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        //AccesoFormularioProxy proxy = new AccesoProxy(" a busqueda de reportes");
        VistaFormulario vista = new FormularioUI(new VistaFormularioReporteFechas());
        Proxy.AccesoFormularioProxy proxy = new Proxy.AccesoProxy("reporte de fechas");
        proxy.acceder(vista, this);
    ...
    private void btnComprobanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprobanteActionPerformed
        ...
        //AccesoFormularioProxy proxy = new AccesoProxy(" a busqueda de comrpobantes");
        VistaFormulario vista = new FormularioUI(new VistaFormularioBuscarComprobante());
        Proxy.AccesoFormularioProxy proxy = new Proxy.AccesoProxy("busqueda de comrpobantes");
        proxy.acceder(vista, this);
    ...
    private void btnRentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRentaActionPerformed
        ...
        //AccesoFormularioProxy proxy = new AccesoProxy(" a rentas");
        VistaFormulario vista = new FormularioUI(new VistaFormularioAlquiler());
        Proxy.AccesoFormularioProxy proxy = new Proxy.AccesoProxy("rentas");
        proxy.acceder(vista, this);
