...
public class ControlAlquiler {
    ...
    public void BuscarProductoAvanzado(String consulta, JTable tablaProducto) {
    ...
    try {
        ...
        Interprete.Expresion expresion = Interprete.Analizador.parse(consulta);
        ...
        while (rs.next()) {
            ...
            if (expresion.interpretar(producto)) {
