...
public class ControlAlquiler {
    ...
    public void gestionarGrupos() {
    ControladorGrupo controladorGrupo = new ControladorGrupo();

    // Crear grupo en la base de datos
    controladorGrupo.crearGrupo("Autos Económicos");

    // Obtener grupo desde la BD
    Grupo grupo = Grupo.obtenerGrupoDesdeBD(1);

    // Mostrar información
    grupo.mostrarInformacion();
    System.out.println("Precio total del grupo: $" + grupo.calcularPrecioTotal());
}
