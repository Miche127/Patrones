...
/**
 *
 * @author Michel Mendezs
 */
public class formClientes extends javax.swing.JFrame {

    private IControlador objetoCliente;
    ...
    public formClientes() {
        ...
        // Usamos la fábrica para obtener el controlador
        objetoCliente = ControladorFactory.crearControlador("cliente");
        
        // Llenamos la tabla con los clientes
        ((ControladorCliente) objetoCliente).Mostrarclientes(tbclientes);

        // Deshabilitamos el campo de ID
    ...
    private void btnguardarclientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarclientesActionPerformed
        ((ControladorCliente) objetoCliente).AgregarCliente(txtnombrecliente, txtappaterno, txtapmaterno);
        ((ControladorCliente) objetoCliente).Mostrarclientes(tbclientes);       
    ...
    private void btnmodificarclientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarclientesActionPerformed
        ((ControladorCliente) objetoCliente).ModificarCliente(idcliente, txtnombrecliente, txtappaterno, txtapmaterno);
        ((ControladorCliente) objetoCliente).Mostrarclientes(tbclientes);
    ...
    private void btneliminarclientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarclientesActionPerformed
        ((ControladorCliente) objetoCliente).EliminarCliente(idcliente);
        ((ControladorCliente) objetoCliente).Mostrarclientes(tbclientes);
    ...
    private void btnlimpiarcampos1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlimpiarcampos1ActionPerformed
        ((ControladorCliente) objetoCliente).limpiarCampos(idcliente, txtnombrecliente, txtappaterno, txtapmaterno);
