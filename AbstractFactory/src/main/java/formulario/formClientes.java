...
public class formClientes extends javax.swing.JFrame {
    ...
    private ControladorCliente objetoCliente;

    public formClientes() {
        

        // ✅ Crear el controlador con el Builder
        objetoCliente = new ControladorCliente.Builder()
            .habilitarLogs(true)  // Cambia a false si no quieres logs
            .mostrarMensajesError(true)
            .build();
        JTable tbclientes = null;

        // ✅ Usar el objeto correctamente
        objetoCliente.mostrarClientes(tbclientes);

        // ✅ Deshabilitar campo de ID cliente
...
@SuppressWarnings("unchecked")
    ...
    private void btnguardarclientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarclientesActionPerformed
        // ✅ Crear el objeto con el Builder
ControladorCliente objetoCliente = new ControladorCliente.Builder()
    .habilitarLogs(true)  // Puedes cambiar a false si no quieres logs
    .mostrarMensajesError(true)
    .build();
...
objetoCliente.limpiarCamposClientes(idcliente, txtnombrecliente, txtappaterno, txtapmaterno);
  ...
  // ✅ Crear la instancia usando el Builder
ControladorCliente objetoCliente = new ControladorCliente.Builder()
    .habilitarLogs(true)  // Puedes cambiar a false si no quieres logs
    .mostrarMensajesError(true)
    .build();
...
objetoCliente.limpiarCamposClientes(idcliente, txtnombrecliente, txtappaterno, txtapmaterno);
    ...
    private void btneliminarclientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarclientesActionPerformed
       // ✅ Crear la instancia correctamente usando el Builder
ControladorCliente objetoCliente = new ControladorCliente.Builder()
    .habilitarLogs(true)  // Puedes poner false si no quieres logs
    .mostrarMensajesError(true)
    .build();

// ✅ Llamar a los métodos con la instancia creada
