...
public class ControlAlquiler {
    ...
    public void calcularTotalPagar(JTable tablaResumen, JLabel IVA, JLabel totalPagar) {
        ...
        Strategy.CalculadoraTotal calculadora = new Strategy.CalculadoraTotal();
        calculadora.setEstrategia(new Strategy.CalculoIVAEstándar());

        double totaliva = calculadora.calcular(modelo);
        double totalFinal = totalSubtotal;

        totalPagar.setText(String.format("%.2f", totalFinal));
